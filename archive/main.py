...
class AnomalyDetection:
    ...
    def get_score_func(self):
        ...
        if not os.path.exists("results"):
            os.makedirs("results")
        result_df.to_csv("results/%s_srrf.csv" % self.file_id, header=True, index=True)
